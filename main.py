...
FILENAMES_DATASETS = {
    ...
    "folklore": "datasets/folklore/all_folklore.txt",

}

FILENAMES_MODELS = {
    "words": "models/model_words.json",
    "chars": "models/model_chars.json",
    "dracula_chars": "models/model_drac_c.json",
    "dracula_words": "models/model_drac_w.json",
    "shakespeare_chars": "models/model_shakespeare_c.json",
    "trump_tweets_chars": "models/model_trump_tweets_c.json",
    "trump_speech_chars_small": "models/model_trump_speech_c_small.json",
    "trump_speech_chars_large": "models/model_trump_speech_c_large.json",
    "trump_tweets_speech": "models/model_trump_tweets_speech.json",
    "folklore_chars": "models/model_folklore_c.json",
}

FILENAMES_WEIGHTS = {
    "words": "weights/model_words.h5",
    "chars": "weights/model_chars.h5",
    "dracula_chars": "weights/model_drac_c.h5",
    "dracula_words": "weights/model_drac_w.h5",
    "shakespeare_chars": "weights/model_shakespeare_c.h5",
    "trump_tweets_chars": "weights/model_trump_tweets_c.h5",
    "trump_speech_chars_small": "weights/model_trump_speech_c_small.h5",
    "trump_speech_chars_large": "weights/model_trump_speech_c_large.h5",
    "trump_tweets_speech": "weights/model_trump_tweets_speech.h5",
    "folklore_chars": "weights/model_folklore_c.h5",
}
...
FILENAMES_VOCAB = {
    ...
    "dracula": "vocabs/dracula_82.json",
    "shakespeare": "vocabs/shakespeare_76.json",
    "folklore": "vocabs/folklore_80.json",
}

# DATASET PARAMETERS
model_filename = FILENAMES_MODELS["folklore_chars"]
weights_filname = FILENAMES_WEIGHTS["folklore_chars"]
data_filename = FILENAMES_DATASETS["folklore"]
vocab_filename = FILENAMES_VOCAB["folklore"]
load_vocab = True
use_chars = True
clean = {
    "lower": False,
...
def train(resume=False):
    if resume:
        model = keras.models.model_from_json(dl.read_file(model_filename))
        model.load_weights(weights_filname)
    else:
    ...
    model.summary()
    dl.write_file(model_filename, model.to_json())

    exit()

    checkpointer = keras.callbacks.ModelCheckpoint(weights_filname, verbose=1, period=1, save_best_only=True,
